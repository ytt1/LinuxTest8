...
Gooooo() {                                   #更新方向
    case ${key:-enter} in
        k|I) [[ ${pos[0]} != "up"    ]] && pos[0]="down";;
        i|K) [[ ${pos[0]} != "down"  ]] && pos[0]="up";;
        j|L) [[ ${pos[0]} != "right" ]] && pos[0]="left";;
        l|J) [[ ${pos[0]} != "left"  ]] && pos[0]="right";;
        s|S) ch_speed;;
        q|Q) snake_exit;;
      enter) game_pause;;
    esac
...
add_node() {                                 #增加节点
    ...
    echo -ne "\033[${xpt[0]};${ypt[0]}H\033[45m${snake[@]:0:1}\033[0m";
    return 0;
}
